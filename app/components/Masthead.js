            ...
            <div className="container mx-auto">
                <div className="w-full md:w-2/3">
                    <h1 className="text-4xl md:text-6xl font-bold text-text mt-20 md:mt-48">
                        Digital Innovation<br />Starts Here
                    </h1>
                    ...
                    <div className="flex mt-8">
                        ...
                        <Link href="/services" className="hidden bg-background text-text text-md font-bold px-8 py-4 border border-text flex items-center md:flex 
                    ">
