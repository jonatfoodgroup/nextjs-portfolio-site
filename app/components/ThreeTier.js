    ...
    <section className="py-4">
      <div className="container mx-auto px-4">
        <div className="flex flex-col">
          <p className="text-gray-500">Energy efficient & cost effective</p>
        ...
        <div className="flex flex-col px-20">
          <div className="flex flex-row mt-10">
            ...
            <div className="flex flex-col w-2/3 pl-8">
              <h2 className="text-4xl font-regular mb-8 w-1/2">
                From concept to manufactured, compliant product.
              </h2>
          ...
          <div className="flex flex-row mt-10">
            ...
            <div className="flex flex-col w-2/3 pl-8">
              <h2 className="text-4xl font-regular mb-8 w-1/2">
                Platform agnostic, portable data intelligence
              </h2>
              <p className="text-gray-500 pr-16">
          ...
          <div className="flex flex-row mt-10">
            ...
            <div className="flex flex-col w-2/3 pl-8">
              <h2 className="text-4xl font-regular mb-8 w-1/2">
                Universal compatibility with all major IoT platforms.
              </h2>
              <p className="text-gray-500 pr-16">
                Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed do
                eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut
